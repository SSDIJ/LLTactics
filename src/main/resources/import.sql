...
-- H2 2.3.232;
INSERT INTO "PUBLIC"."HEROE" (vida, armadura, faccion, precio, probabilidad, daño, velocidad, tipo, descripcion, imagen, nombre, probabilidad_critico) VALUES
(300, 75, 0, 3, 0.4, 150, 75, 'Heroe', U&'Firme como una muralla de acero, el Tanque es la primera l\00ednea de defensa, imparable ante los embates enemigos. Con 300 de vida y una resistencia formidable, se erige como el escudo de sus compa\00f1eros en el fragor de la batalla.', '/img/units/humans/1. Tanque/heavyinfantry.png', 'Tanque', 0.3),
(262, 45, 0, 4, 0.2, 112, 56, 'Heroe', U&'Sabio en las artes de la estrategia, el General no solo combate, sino que gu\00eda a sus tropas con astucia. Con una armadura ligera pero letal en combate, sus t\00e1cticas dan la ventaja en el campo de batalla.', '/img/units/humans/2. General/general.png', 'General de Guerra', 0.2),
(225, 68, 0, 3, 0.4, 150, 45, 'Heroe', U&'\00c1gil y feroz, el Caballero es un guerrero que destaca por su destreza y valor. Con gran habilidad en el combate cuerpo a cuerpo, su espada brilla como un rayo de esperanza para su gente.', '/img/units/humans/3. Caballero/knight.png', 'Caballero', 0.5),
(150, 37, 0, 2, 0.4, 90, 68, 'Heroe', U&'El ojo certero del ej\00e9rcito, el Arquero lanza flechas como estrellas fugaces. Con punter\00eda mortal, su habilidad para atacar desde lejos es esencial para desgastar al enemigo antes de que se acerque.', '/img/units/humans/4. Arquero/longbowman-bow-attack-1.png', 'Arquero', 0.3),
(187, 30, 0, 5, 0.35, 135, 45, 'Heroe', U&'El conjurador de fuerzas arcanas, el Mago domina la magia como un tejedor de destinos. Su poder radica en su habilidad para controlar el fuego, el hielo y otras artes m\00edsticas, arrasando a sus enemigos desde la distancia.', '/img/units/humans/5. Mago/white-mage.png', 'Mago', 0.4),
...
(280, 85, 2, 3, 0.35, 120, 70, 'Heroe', U&'Una bestia imparable, el Troll Gigante es una masa de m\00fasculo y furia. Su fuerza descomunal lo convierte en un enemigo temido en las l\00edneas de batalla, capaz de aplastar a cualquier rival con un solo golpe.', '/img/units/trolls/1. TTanque/great-troll.png', 'Troll Gigante', 0.5),
(250, 50, 2, 2, 0.35, 135, 60, 'Heroe', U&'La sombra que corta, el Troll Asesino se desliza entre las sombras con agilidad mortal. Sus ataques furtivos y r\00e1pidos dejan a sus enemigos sin aliento, antes de que puedan siquiera reaccionar a su presencia.', '/img/units/trolls/2. TAssasin/whelp.png', 'Troll Asesino', 0.5),
(275, 60, 2, 3, 0.4, 175, 50, 'Heroe', U&'El combatiente equilibrado, el Troll Guerrero es un maestro del combate con habilidades tanto ofensivas como defensivas. Su resistencia y destreza le permiten mantenerse firme, enfrentando a sus adversarios con una feroz determinaci\00f3n.', '/img/units/trolls/3. TOfftanque/warrior.png', 'Troll Guerrero', 0.5),              
(170, 30, 2, 2, 0.4, 110, 80, 'Heroe', U&'La mano que nunca falla, el Troll Certero es un experto en el arte de los ataques a distancia. Con gran precisi\00f3n, lanza sus proyectiles como flechas al coraz\00f3n de sus enemigos, eliminando amenazas desde lejos con punter\00eda infalible.', '/img/units/trolls/4. TRango/lobber.png', 'Troll Certero', 0.5),
(210, 25, 2, 4, 0.2, 160, 50, 'Heroe', U&'El invocador de fuerzas oscuras, el Troll Cham\00e1n usa su conexi\00f3n m\00edstica con la naturaleza y los esp\00edritus para invocar poderosos hechizos que apoyan a sus aliados y desestabilizan a sus enemigos. Su magia es tan impredecible como las tormentas.', '/img/units/trolls/5. TMago/shaman.png', U&'Troll Cham\00e1n', 0.5),
(295, 70, 3, 3, 0.4, 140, 60, 'Heroe', U&'El guerrero eterno, el Esqueleto Corpulento resiste las heridas del tiempo y el combate. Su enorme resistencia lo convierte en una fortaleza ambulante, capaz de soportar grandes da\00f1os y seguir luchando con furia implacable.', '/img/units/skeletons/1. STanque/draug.png', 'Esqueleto Corpulento', 0.5),
(235, 55, 3, 4, 0.35, 125,70, 'Heroe', U&'El l\00edder de los muertos, el Esqueleto General emana una presencia temible que inspira terror y respeto. Su destreza t\00e1ctica y su voluntad inquebrantable lo convierten en el comandante perfecto para las huestes de la no muerte.', '/img/units/skeletons/2. SGeneral/deathknight.png', 'Esqueleto General', 0.5),
(260, 75, 3, 4, 0.2, 165, 45, 'Heroe', U&'La sombra r\00e1pida, el Esqueleto a caballo es un jinete espectral que asola el campo con su destreza y velocidad. Mortal en combate, se mueve con la gracia de una tormenta, causando estragos entre las filas enemigas.', '/img/units/skeletons/3. SCaballero/boneknight-attack.png', 'Esqueleto a caballo', 0.5),
(180, 25, 3, 3, 0.4, 130, 85, 'Heroe', U&'La flecha de la muerte, el Esqueleto Arquero lanza sus proyectiles con una precisi\00f3n mortal. Desde la distancia, derrumba a sus enemigos uno por uno, como un cazador que acecha a su presa.', '/img/units/skeletons/4. SArquero/banebow-bow.png', 'Esqueleto Arquero', 0.5),
(220, 20, 3, 5, 0.35, 150, 55, 'Heroe', 'El hechicero del abismo, el Esqueleto Mago invoca oscuros hechizos que devoran todo a su paso. Su magia arcana es tan poderosa como su cuerpo esqueleto, y arrastra a sus enemigos hacia la oscuridad.', '/img/units/skeletons/5. SMago/ancient-lich.png', 'Esqueleto mago', 0.5),
(400, 120, 4, 6, 0.05, 200, 40, 'Heroe', U&'El espectro de fuego eterno, la Criatura Legendaria es una aparici\00f3n envuelta en llamas ardientes, cuya existencia desaf\00eda la realidad. Con habilidades extraordinarias, su poder es tan vasto como las llamas que consume, arrasando con todo a su paso.', '/img/units/legendary/fireghost/fireghost.png', 'Criatura Legendaria', 0.5);          
