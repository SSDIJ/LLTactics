...
(TRUE, 0, 0, 0, 0, 0, 1, 'Admin', 'Administrez', '{bcrypt}$2a$10$GU4mO.Uxc.tRP3.DsrBIvO3543uERYAvJwkuplrpFTAYdXoteTFOm', 'ADMIN,USER', 'pruebaAdmin123'),
(TRUE, 0, 0, 0, 0, 0, 2, 'Usuario', 'Usuariez', '{bcrypt}$2a$10$2BpNTbrsarbHjNsUWgzfNubJqBRf.0Vz9924nRSHBqlbPKerkgX.W', 'USER', 'usuarioMolon77');
